...
public class PlatformCapabilities
{
    ...
    public static void initHandlers() {
        ...
        ItemStorage.SIDED.registerForBlockEntity(DrawerStorageImpl::of, ModBlockEntities.STANDARD_DRAWERS_1.get());
        ItemStorage.SIDED.registerForBlockEntity(DrawerStorageImpl::of, ModBlockEntities.STANDARD_DRAWERS_2.get());
        ItemStorage.SIDED.registerForBlockEntity(DrawerStorageImpl::of, ModBlockEntities.STANDARD_DRAWERS_4.get());
        ItemStorage.SIDED.registerForBlockEntity(DrawerStorageImpl::of, ModBlockEntities.FRACTIONAL_DRAWERS_2.get());
        ItemStorage.SIDED.registerForBlockEntity(DrawerStorageImpl::of, ModBlockEntities.FRACTIONAL_DRAWERS_3.get());
