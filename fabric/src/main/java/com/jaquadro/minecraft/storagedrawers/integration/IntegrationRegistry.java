...
public class IntegrationRegistry
{
    ...
    public void init () {
        for (int i = 0; i < registry.size(); i++) {
            ...
            if (module.getModID() != null && !FabricLoader.getInstance().isModLoaded(module.getModID())) {
                registry.remove(i--);
                continue;
            }
            ...
            try {
                ...
                registry.remove(i--);
                ModServices.log.info("Could not load integration module: " + module.getClass().getName());
            }
        }
    }
