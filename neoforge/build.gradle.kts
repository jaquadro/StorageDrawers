...
dependencies {
    // JEI
    runtimeOnly("mezz.jei:jei-${Versions.minecraft}-neoforge:30.32.0.215")
    // JADE - Jade-mc26.2-NeoForge-26.2.10 (MC 26.2)
    implementation("curse.maven:jade-324717:8755115")
}
