...
public final class ModBlocks
{
    ...
    public static final RegistryObject<BlockStandardDrawers>
        ...
        CHERRY_FULL_DRAWERS_1 = registerWoodenDrawerBlock("cherry_full_drawers_1", 1, false),
        CHERRY_FULL_DRAWERS_2 = registerWoodenDrawerBlock("cherry_full_drawers_2", 2, false),
        CHERRY_FULL_DRAWERS_4 = registerWoodenDrawerBlock("cherry_full_drawers_4", 4, false),
        CHERRY_HALF_DRAWERS_1 = registerWoodenDrawerBlock("cherry_half_drawers_1", 1, true),
        CHERRY_HALF_DRAWERS_2 = registerWoodenDrawerBlock("cherry_half_drawers_2", 2, true),
        CHERRY_HALF_DRAWERS_4 = registerWoodenDrawerBlock("cherry_half_drawers_4", 4, true),
        BAMBOO_FULL_DRAWERS_1 = registerWoodenDrawerBlock("bamboo_full_drawers_1", 1, false),
        BAMBOO_FULL_DRAWERS_2 = registerWoodenDrawerBlock("bamboo_full_drawers_2", 2, false),
        BAMBOO_FULL_DRAWERS_4 = registerWoodenDrawerBlock("bamboo_full_drawers_4", 4, false),
        BAMBOO_HALF_DRAWERS_1 = registerWoodenDrawerBlock("bamboo_half_drawers_1", 1, true),
        BAMBOO_HALF_DRAWERS_2 = registerWoodenDrawerBlock("bamboo_half_drawers_2", 2, true),
        BAMBOO_HALF_DRAWERS_4 = registerWoodenDrawerBlock("bamboo_half_drawers_4", 4, true),
    ...
    public static final RegistryObject<BlockTrim>
        ...
        CHERRY_TRIM = registerTrimBlock("cherry_trim"),
        BAMBOO_TRIM = registerTrimBlock("bamboo_trim"),
