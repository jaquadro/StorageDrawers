...
public final class ModCommonConfig extends ConfigSpec
{
    ...
    public class Integration {
        ...
        public class CofhCore extends ConfigSection {
            public final ChameleonConfig.ConfigEntry<Boolean> enable;

            public CofhCore (String name, String... comment) {
                super(name, comment);

                enable = commonConfig.define("enable", true)
                    .comment("Enables CoFH Core integration if mod is present.");
            }
        ...
        public Integration () {
            ...
            cofhCore = new CofhCore("CoFHCore",
                "Configuration around the CoFH Core mod.",
                "Adds support for a CoFH groups personal key.").build();
