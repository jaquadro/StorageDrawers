...
public final class ModItems
{
    ...
    public static final RegistryEntry<? extends Item>
        ...
        PULL_UPGRADE = ITEMS.register("pull_upgrade", () -> new ItemUpgradePull(1, new Item.Properties())),
        PULL_UPGRADE_2 = ITEMS.register("pull_upgrade_2", () -> new ItemUpgradePull(2, new Item.Properties())),
        PULL_UPGRADE_3 = ITEMS.register("pull_upgrade_3", () -> new ItemUpgradePull(3, new Item.Properties())),
        PUSH_UPGRADE = ITEMS.register("push_upgrade", () -> new ItemUpgradePush(1, new Item.Properties())),
        PUSH_UPGRADE_2 = ITEMS.register("push_upgrade_2", () -> new ItemUpgradePush(2, new Item.Properties())),
        PUSH_UPGRADE_3 = ITEMS.register("push_upgrade_3", () -> new ItemUpgradePush(3, new Item.Properties())),
    ...
    static void registerBlock (ChameleonRegistry<Item> register, RegistryEntry<? extends Block> blockHolder) {
        ...
        register.register(blockHolder.getId().getPath(), () -> {
            ...
            if (block instanceof BlockFramedStandardDrawers) {
                ...
                return new ItemControllerIO(block, new Item.Properties());
