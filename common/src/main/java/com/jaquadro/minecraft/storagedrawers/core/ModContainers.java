...
public class ModContainers
{
    ...
    private static <C extends ContainerDrawers> RegistryEntry<MenuType<C>> registerContainer(String name, ChameleonContainer.ChameleonContainerFactory<C> containerFactory) {
        return CONTAINERS.register(name, ChameleonServices.CONTAINER.getContainerSupplier(containerFactory));
    }
